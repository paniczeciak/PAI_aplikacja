...
ERROR;
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="./index.php" class="h1"><b>Kukła</b></a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Zarejestruj się, aby zarezerwować stolik!</p>
      ...
      <form action="../scripts/register_user.php" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Numer telefonu" name="phoneNumber">
          <div class="input-group-append">
            <div class="input-group-text">
